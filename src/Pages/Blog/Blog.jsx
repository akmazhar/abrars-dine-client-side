...
const Blog = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <img src="https://i.ibb.co/yf1jSkP/Screenshot-2023-11-07-192756.png" className="max-w-sm rounded-lg shadow-2xl" />
    <div>
...
<div className="hero min-h-screen bg-green-300 shadow-2xl rounded-e-full rounded-s-2xl ">
  <div className="hero-content flex-col lg:flex-row">
    <img src="https://i.ibb.co/xzrxXqt/Node-JS-Npm-01-1.png" className="max-w-sm rounded-lg shadow-2xl" />
    <div>
...
<div className="card w-full bg-lime-300 shadow-2xl rounded-t-full rounded-s-2xl">
  <figure className="px-4 pt-4">
    <img src="https://i.ibb.co/wQMn0W0/mongodb-vs-mysql.jpg" alt="" className="rounded-xl" />
  </figure>
