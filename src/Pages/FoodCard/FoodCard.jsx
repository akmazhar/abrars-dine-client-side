    ...
    return (
        <div className="card w-full glass bg-orange-100 shadow-2xl shadow-lime-500 rounded-3xl">
            ...
            <div className="card-body bg-orange-50 rounded-s-full">
                ...
                <h3 className="px-8 font-semibold text-slate-400" >Food Category : <i className="text-red-600 text-xl font-mono">{category}</i></h3>
                <p className="px-24 font-semibold text-black font-mono">Price: <span className="text-green-600">$ {price}</span></p>
